...
1. **Agentic search surface** (landed 2026-07-09 — see `docs/plans/2026-07-09-agentic-search-spec.md`): agents get ripgrep/glob/file-read tools; hybrid archival search is a recall booster with optional `path_prefix`. Symbol-lookup / repo-map remains roadmap item 2.
