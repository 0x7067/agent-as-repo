...
export default tseslint.config(
	...
	},
	{
		files: [
			...
			"src/shell/adapters/node-git.test.ts",
			"src/shell/agent-factory.test.ts",
			"src/shell/block-storage.test.ts",
			"src/shell/doctor.stryker.test.ts",
			"src/shell/doctor.test.ts",
			"src/shell/file-collector.test.ts",
			"src/shell/group-provider.test.ts",
